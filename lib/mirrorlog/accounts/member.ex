defmodule Mirrorlog.Accounts.Member do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Mirrorlog.Repo)
  ...
  """
  def valid_password?(%Mirrorlog.Accounts.Member{hashed_password: hashed_password}, password)
