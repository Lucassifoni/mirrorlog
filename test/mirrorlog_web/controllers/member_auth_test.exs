defmodule MirrorlogWeb.MemberAuthTest do
  use MirrorlogWeb.ConnCase

  alias Mirrorlog.Accounts
  alias MirrorlogWeb.MemberAuth
  import Mirrorlog.AccountsFixtures

  @remember_me_cookie "_mirrorlog_web_member_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, MirrorlogWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_member/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      MirrorlogWeb.Endpoint.subscribe(live_socket_id)
